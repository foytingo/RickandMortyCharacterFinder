...
class CharacterInfoVC: CFDataLoadingVC {
    ...
    private func configureHeaderView(){
        ...
        NSLayoutConstraint.activate([
            headerView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: padding15),
            headerView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: padding15),
            headerView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -padding15),
    ...
    private func configureEpisodesLabel(){
        ...
        NSLayoutConstraint.activate([
            episodesLabel.topAnchor.constraint(equalTo: headerView.bottomAnchor, constant: padding15),
            episodesLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: padding15),
            episodesLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -padding15),
    ...
    func configureTableView(){
        ...
        NSLayoutConstraint.activate([
            ...
            tableView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: padding15),
            tableView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -padding15),
            tableView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -padding15)
        ])
